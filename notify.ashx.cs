...
namespace OS_Sog.DNN.NBrightStore
{
    /// <summary>
    /// Summary description for XMLconnector
    /// </summary>
    public class OS_SogNotify : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                int OS_SogStoreOrderID = 0;
                string OS_SogCartID = "";
                string OS_SogClientLang = "";
                ...
                if (Utils.IsNumeric(orderid))
                {
                    ...
                    OS_SogStoreOrderID = Convert.ToInt32(orderid);
                    // ------------------------------------------------------------------------
                    ...
                    var orderData = new OrderData(OS_SogStoreOrderID);
            ...
            catch (Exception ex)
            {
                ...
                {
                    info.SetXmlProperty("genxml/debugmsg", "OS_Sog ERROR: " + ex.ToString());
                    modCtrl.Update(info);
                }
            }
